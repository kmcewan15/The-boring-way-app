...
export const TOPIC_QUIZZES: Record<number, QuizQuestion[]> = {
  1: [
    ...
    {
      id: 't1q3',
      question: 'You ask Claude what is in the folder and it lists files you do not recognise. What has most likely happened?',
      options: [
        'It is showing you files from an earlier session',
        'It is guessing at what a project like yours usually contains',
        'You started it in the wrong folder',
        'It has reached files elsewhere on your machine',
      ],
      answer: 2,
      why: 'The folder you start Claude in is the whole of what it can see, so a list you do not recognise almost always means you are somewhere you did not intend to be. Check the folder it named when it started.',
    },
  ],
